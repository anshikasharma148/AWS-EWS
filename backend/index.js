...
const ewsGraphRoute = require('./routes/ewsGraphRoutes');
const ewsStationAllDataRoute = require('./routes/ewsStationAllData');
...
app.use('/api/ews-graph', ewsGraphRoute);
app.use('/api/ews-all', ewsStationAllDataRoute);
